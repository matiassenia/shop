...
urlpatterns = [
      ...
      path( 'actualizar-cantidad-elemento-carrito/<int:elemento_id>/<int:nueva_cantidad>/', views.actualizar_cantidad_elemento_carrito, name='actualizar_cantidad_elemento_carrito'),
]
